...
launcher = 'none'
load_from = 'work_dirs/repstdc-ca_512x512_80k_fbp24/iter_80000.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        data_prefix=dict(img_path='imgs/val', seg_map_path='gts24/val'),
        data_root='data/gid',
        pipeline=[
...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir='out/ca-fbp24/test-output',
    type='IoUMetric')
test_pipeline = [
    dict(imdecode_backend='tifffile', type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
train_dataloader = dict(
    batch_size=32,
    dataset=dict(
        data_prefix=dict(img_path='imgs/train', seg_map_path='gts24/train'),
        data_root='data/gid',
        pipeline=[
            dict(imdecode_backend='tifffile', type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
...
work_dir = './work_dirs/repstdc-ca_512x512_80k_fbp24'
